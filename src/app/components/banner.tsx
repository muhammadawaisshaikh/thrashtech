                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-30">
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                            ...
                            <a href="#" className="font-semibold text-dark-600"><span className="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
                        </div>
                    </div>
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Collaborator to enrich your Innovations</h1>
                        <p className="mt-6 text-lg leading-8 text-gray-600">A worldwide digital collaborator that assists businesses in undergoing transformation, innovating new products, and expanding their teams.</p>
